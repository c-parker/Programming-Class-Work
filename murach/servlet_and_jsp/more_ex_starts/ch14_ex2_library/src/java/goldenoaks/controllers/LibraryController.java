...
public class LibraryController extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        switch (action) {
            ...
            case "sendOverdueNotices":
                url = sendOverdueNotices(request, response);
                break;
        }
    ...
    private String manage(HttpServletRequest request,
            HttpServletResponse response) {
        List<Checkout> checkedOutList = CheckoutDb.selectCheckedOutBooks();
    ...
    private String sendOverdueNotices(HttpServletRequest request,
            HttpServletResponse response) {
        
        //TODO: Implement code to send overdue notices.
        
        return "/overdueSent.jsp";
    }
